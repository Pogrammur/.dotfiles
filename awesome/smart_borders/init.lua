...
local function new(config)
	...
	local border_width = cfg.border_width or dpi(3)
	local rounded_corner = cfg.rounded_corner or dpi(10)

	local color_normal = cfg.color_normal or "#02283d"
	local color_focus = cfg.color_focus or "#6e02ad"
